...
public sealed class Recording
{
    ...
    public async Task StartAsync(JwtToken accessToken, string conferenceId, string layoutUrl = null)
    {
        ...
        string url = $"{Urls.CAPI_BASE_URL}/v2/conferences/mix/{conferenceId}/recording/start";
    ...
    {
        string url = $"{Urls.CAPI_BASE_URL}/v2/conferences/mix/{conferenceId}/recording/stop";
