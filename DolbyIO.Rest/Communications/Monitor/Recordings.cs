...
namespace DolbyIO.Rest.Communications.Monitor
{
    public sealed class Recordings
    {
        ...
        {
            string url = $"{Urls.COMMS_BASE_URL}/v1/monitor/conferences/{conferenceId}/recordings";
        ...
        {
            string url = $"{Urls.COMMS_BASE_URL}/v1/monitor/conferences/{conferenceId}/recordings/audio";
