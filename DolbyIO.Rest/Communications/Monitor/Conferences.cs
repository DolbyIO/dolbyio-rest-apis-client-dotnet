...
namespace DolbyIO.Rest.Communications.Monitor
{
    public sealed class Conferences
    {
        ...
        {
            string url = $"{Urls.COMMS_BASE_URL}/v1/monitor/conferences/${conferenceId}?livestats=${liveStats}";
        ...
        {
            string url = $"{Urls.COMMS_BASE_URL}/v1/monitor/conferences/${conferenceId}/statistics";
